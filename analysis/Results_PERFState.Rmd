...
ls_simNames <- 
  c("miscAll_baseline",
    ...
    "miscAll_benCut1&colaCut1_lowERC",
    "miscAll_benCut1&colaCut1_highERC",
    ...
    "miscAll_benCut2&colaCut2_lowERC",
    "miscAll_benCut2&colaCut2_highERC",
    ...
    "sftyAll_benCut1&colaCut1_lowERC",
    "sftyAll_benCut1&colsCut1_highERC",
    ...
    "sftyAll_benCut2&colaCut2_lowERC",
    "sftyAll_benCut2&colsCut2_highERC"
)
...
df_results <- 
  ...
  mutate(sim_name = str_replace(sim_name, "&", "_"),
         sim_name = factor(sim_name, levels = str_replace(ls_simNames, "&", "_")),
         )
