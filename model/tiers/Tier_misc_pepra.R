...
#'  
#'  - Benefit rules
#'      - PEPRA 2%@62 rules. (members who joined after 1/1/2013)
#'      
#'  - Final compensation 
#'      - The plan policy: 
...
grp_include <- grp_include[str_detect(grp_include , "misc_pepra|inds_pepra")]
...
wgts[wgts$grp == "misc_t1_female","wgt"] <-  0.258 * 0.918/(0.918+0.018) * 0.6
wgts[wgts$grp == "misc_t1_male",  "wgt"] <-  0.258 * 0.918/(0.918+0.018) * 0.4
wgts[wgts$grp == "misc_t2_female","wgt"] <-  0.258 * 0.018/(0.918+0.018) * 0.6
wgts[wgts$grp == "misc_t2_male",  "wgt"] <-  0.258 * 0.018/(0.918+0.018) * 0.4
wgts[wgts$grp == "inds",  "wgt"]         <-  0.017
...
wgts[wgts$grp == "misc_t1",  "wgt"] <-  0.258 * 0.918/(0.918+0.018)
wgts[wgts$grp == "misc_t2",  "wgt"] <-  0.258 * 0.018/(0.918+0.018)
wgts[wgts$grp == "inds",     "wgt"] <-  0.017
...
# df_n_servRet_tier$n_servRet
# df_n_disbRet_tier$n_distRet
